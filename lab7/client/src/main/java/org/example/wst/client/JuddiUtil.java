...
public class JuddiUtil {
    ...
    public static void printBusinessDetail(BusinessInfo businessInfo) {
        System.out.println("===============================================");
        System.out.println("Ключ бизнеса: " + businessInfo.getBusinessKey());
        System.out.println("Имя: " + businessInfo.getName().stream()
                .map(Name::getValue)
                .collect(Collectors.joining(" "))
        );

        System.out.println("Описание: " + businessInfo
                .getDescription()
                .stream()
    ...
    public static void printServiceInfo(BusinessService businessService) {
        System.out.println("Ключ сервиса: " + businessService.getServiceKey());
        System.out.println("Ключ бизнеса-владельца: " + businessService.getBusinessKey());
        System.out.println("Имя: " + businessService.getName().stream()
